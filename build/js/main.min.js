...
const initButtons = () => {
  ...
  deleteDataButton.addEventListener('click', _print_js__WEBPACK_IMPORTED_MODULE_1__["resetTable"]);
};
...
const getData = (onSuccess, onFail) => {
  ...
  fetch('https://swapi.dev/api/starships/')
      ...
      .then((data) => {
        onSuccess(data);
        setTimeout(_preloader_js__WEBPACK_IMPORTED_MODULE_0__["hidePreloader"], 500);
      })
      .catch(() => {
        onFail();
        setTimeout(_preloader_js__WEBPACK_IMPORTED_MODULE_0__["hidePreloader"], 500);
